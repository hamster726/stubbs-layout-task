            ...
            <section className="header">
                <div className="container">
                    ...
                    <div className="header__menu">
                        <ul>
                            <li><a href="" className="header__tab active">Главная</a></li>
                            <li><a href="" className="header__tab">Услуги</a></li>
                            <li><a href="" className="header__tab">Наши работы</a></li>
                            <li><a href="" className="header__tab">О нас</a></li>
                            <li><a href="" className="header__tab">Контакты</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="header__lang">
                        ...
                        <button className="header__lang__dropdown-button"><img src={vectorImg} alt="vector arrow"/></button>
                    </div>
                        </div>
                </div>
                </div>
